  ...
  const questions: Question[] = [
    {
      ...
      correctIndex: 1,
      explanation: 'Chính xác! Khi tốc độ khách đến λ vượt quá tổng năng lực phục vụ c·μ, hệ thống không bao giờ có thể "giải phóng" hết hàng chờ. Về mặt toán học, độ dài hàng Lq sẽ tiến tới vô cùng (Infinite queue).',
    },
    {
      id: 2,
      ...
      correctIndex: 2,
      explanation: 'Chính xác! L = λ · W là định luật nền tảng được chứng minh bởi John Little năm 1961. Định luật này đúng cho mọi hệ thống ở trạng thái dừng, không cần biết phân phối dòng đến hay quy luật phục vụ là gì.',
    },
    {
      id: 3,
      ...
      correctIndex: 1,
      explanation: 'Chính xác! Với M/M/1, phương sai là σ² = 1/μ², nên Lq = ρ² / (1 - ρ). Với M/D/1 (σ² = 0), Lq = ρ² / [2(1 - ρ)], tức là giảm đúng 50%! Điều này chứng minh việc "chuẩn hóa quy trình để giảm dao động" đem lại hiệu quả to lớn trong vận hành.',
    },
    {
      id: 4,
      ...
      correctIndex: 2,
      explanation: 'Chính xác! Mô hình 1 hàng chung (M/M/c) tối đa hóa hiệu suất sử dụng: ngay khi có bất kỳ quầy nào hoàn tất, khách đầu hàng lập tức được gọi vào. Không bao giờ xảy ra cảnh 1 quầy ngồi chơi trong khi hàng bên cạnh kẹt cứng.',
    },
    {
      id: 5,
      question: 'Sự khác biệt căn bản giữa hai hiện tượng Balking (Quay xe) và Reneging (Bỏ cuộc) của khách hàng là gì?',
      options: [
        'A. Balking là bỏ đi ngay khi mới nhìn thấy hàng quá đông; Reneging là đã vào hàng đứng chờ một lúc rồi mới mất kiên nhẫn bỏ về.',
        'B. Balking xảy ra ở siêu thị, Reneging xảy ra ở tổng đài điện thoại.',
        'C. Balking là hành vi của khách VIP, Reneging là khách thường.',
        'D. Hai thuật ngữ này là từ đồng nghĩa hoàn toàn trong lý thuyết xác suất.',
      ],
      correctIndex: 0,
      explanation: 'Chính xác! Balking = thấy hàng dài nên không thèm vào xếp hàng. Reneging = đã xếp hàng nhưng sốt ruột vì đợi quá lâu nên bỏ cuộc giữa chừng.',
    },
    {
      id: 6,
      question: 'Trong bài toán tối ưu hóa kinh tế hàng chờ, điểm tối ưu c* là điểm mà tại đó:',
      options: [
        'A. Thời gian chờ của khách hàng bằng đúng 0 giây.',
        'B. Nhân viên làm việc 100% công suất không có thời gian nghỉ.',
        'C. Tổng chi phí TC(c) = Cs · c + Cw · L đạt giá trị nhỏ nhất (cực tiểu).',
        'D. Số lượng quầy c đạt giá trị lớn nhất có thể.',
      ],
      correctIndex: 2,
      explanation: 'Chính xác! Doanh nghiệp không thể mở vô hạn quầy (vì tốn chi phí Cs), cũng không thể để khách chờ quá lâu (vì tổn thất Cw). Điểm tối ưu kinh tế chính là giao điểm cân bằng giúp tổng chi phí đạt giá trị nhỏ nhất.',
    },
  ];
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-xs text-slate-400">
                Bạn đã trả lời đúng <strong className="text-cyan-300 font-mono text-sm">{correctCount}/{questions.length}</strong> câu hỏi ({((correctCount / questions.length) * 100).toFixed(0)}%).
              </p>
            </div>
          </div>
          <button
